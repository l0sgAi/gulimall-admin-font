  ...
  <div class="rr-login">
    <div class="rr-login-wrap">
      <div class="rr-login-left hidden-sm-and-down">
        <p class="rr-login-left-title">谷粒商城后台管理系统</p>
      </div>
          ...
          <el-form ref="formRef" label-width="80px" :status-icon="true" :model="login" :rules="rules"
            ...
            <el-form-item label-width="0" prop="captcha">
              <el-space class="rr-login-right-main-code">
                ...
                <img style="vertical-align: middle; height: 40px; cursor: pointer" :src="state.captchaUrl"
    ...
    <div class="login-footer">
      <p><a href="https://www.renren.io/enterprise" target="_blank">企业版</a> | <a href="https://www.renren.io/cloud"
          target="_blank">微服务版</a></p>
